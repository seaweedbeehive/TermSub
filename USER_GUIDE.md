...
To run TermSub, see the [README.md](../README.md) for setup instructions. You have two options:
...
Once the app is running, open **`http://localhost:8000`** in your browser and follow the workflow below.
