...
def get_video_with_session(video_id: str) -> tuple[str, str, str | None, str]:
...
def update_video_status(video_id: str, status: str, **kwargs: Any) -> bool:
...
def get_video_segments(video_id: str, limit: int | None = None) -> list[Any]:
