...
IMPORTANT: The original term MUST be written exactly as it appears in the transcript's source language. Do NOT translate the original field into English. For terms with multiple {target_language} translations, provide the MOST STANDARD/ACADEMIC translation used in {target_language} political discourse.""",
...
IMPORTANT: The original term MUST be written exactly as it appears in the transcript's source language. Do NOT translate the original field into English. Use the standard {target_language} medical terminology.""",
...
IMPORTANT: The original term MUST be written exactly as it appears in the transcript's source language. Do NOT translate the original field into English. Use established {target_language} psychological terminology.""",
...
IMPORTANT: The original term MUST be written exactly as it appears in the transcript's source language. Do NOT translate the original field into English. Use standard {target_language} sociological academic terminology.""",
