...
def upgrade() -> None:
    ...
    op.create_index('idx_job_queue_video_status', 'job_queue', ['video_id', 'status'], unique=False)
    op.create_index(op.f('ix_job_queue_celery_task_id'), 'job_queue', ['celery_task_id'], unique=False)
    op.create_index(op.f('ix_job_queue_job_type'), 'job_queue', ['job_type'], unique=False)
    op.create_index(op.f('ix_job_queue_locked_by'), 'job_queue', ['locked_by'], unique=False)
    op.create_index(op.f('ix_job_queue_video_id'), 'job_queue', ['video_id'], unique=False)
    ...
    op.create_index('idx_segments_video_seq', 'segments', ['video_id', 'sequence_number'], unique=False)
    ...
    op.create_table('term_occurrences',
    sa.Column('id', sa.String(length=36), nullable=False),
    ...
    op.create_table('translation_variants',
    sa.Column('id', sa.String(length=36), nullable=False),
    sa.Column('term_id', sa.String(length=36), nullable=False),
